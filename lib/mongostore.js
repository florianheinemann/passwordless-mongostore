...
MongoStore.prototype.authenticate = function(token, uid, callback) {
	...
	this._get_collection(function(collection) {
		collection.findOne({hashedToken: token, uid: uid,
 ...
 */
MongoStore.prototype.invalidateToken = function(token, callback) {
	if(!token || !callback) {
		throw new Error('TokenStore:invalidateToken called with invalid parameters');
	}
	this._get_collection(function(collection) {
